...
export function findAllQuestion(req, res){
    ...
    var _values = [];
    var _values2 = [];
    connection.query("SELECT * FROM classes LEFT JOIN subjects ON classes.classId = subjects.subjectId LEFT JOIN question ON subjects.subjectId = question.SubjectId").then((result)=>{
        var scheme = {
