...
class QuestionsList extends Component {
    ...
    componentWillReceiveProps(Props){
      console.log("newpropquestion", Props)
        if(Props.question){
            this.setState({
             Question:Props.question.data
            })
        }
        if(Props.subjects && Props.classess){
          this.setState({
           subject:Props.subjects.data,
           alldata: Props.classess.data 
          })
      }
    ...
    handleSubmit = (event, errors, values) => {
      ...
      const id = this.state.editDate.Qid;
   ...
   onDelete = (data) =>{
      console.log(data)
      this.props.actions.DeleteQuestion(data.Qid)
   }
  
      render() {
        const { visible, loading, Question, subject, alldata, editDate } = this.state;
        console.log("visible", alldata, subject, editDate)
        return (
         <div>
